...
def buildDict(passports):
    dictionaries = []
    for element in passports:
        values = "{" + element.__str__()[1:-1] + "}"
        values = values.replace(":","':'")
        dictionary = eval(values)
        dictionaries.append(dictionary)

    return dictionaries

def validatePassports(dictionaries):
...
def validatePassports2(dictionaries):
    fields = ["byr","iyr","eyr","hgt","hcl","ecl","pid"]
    valid = []
    counter = 0
    for dictionary in dictionaries:
            ...
            if dictionary.get(field):
                ...
                if field == "byr":
                    ...
                    try:
                        ...
                        value = 0
                    if (150 <= value <= 193 and unit == "cm") or (59 <= value <= 76 and unit == "in"):
                        valid.append(True)
                    else:
                        valid.append(False)
                elif field == "hcl":
                    try:
                        value = re.fullmatch("[#]\w{6}",value).string
                    except:
                        value = ""
                    if value != "":
                        valid.append(True)
                    ...
                    try:
                        value = re.fullmatch("\d{9}",value).string
                    except:
                        value = ""
                    if value != "":
                        valid.append(True)
        ...
        valid = []
    return counter
print(validatePassports2(buildDict(getPassports(DATA))))
